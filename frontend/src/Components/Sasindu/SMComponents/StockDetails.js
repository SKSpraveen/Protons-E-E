                ...
                <tbody>
                    {dataList.map((stock) => (
                        <tr key={stock.id}>
                            ...
                            <td>
                                <button type="button" onClick={() => navigate(`/editStock/${stock._id}`)} className="btnActionSM1">Edit</button> <button type="button" onClick={() => handleDelete(stock._id)} className="btnActionSM2">Remove</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
